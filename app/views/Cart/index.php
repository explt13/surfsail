            ...
            <div class="cart__body">
                ...
                if ($products): 
                    foreach ($products as $product): ?>
                        <div class="cart-item" data-qty=<?= htmlspecialchars($product['qty']);?> data-id=<?= htmlspecialchars($product['id'], ENT_QUOTES, 'UTF-8');?>>
        ...
        <div class="cart__footer footer-cart">
            <div class="container footer-cart__container">
                <div class="footer-cart__body">
                    <div class="footer-cart__items"><?php
                    if ($products) {
                        echo htmlspecialchars(count($products), ENT_QUOTES, 'UTF-8');
                    } else {
                        echo 0;
                    }
                    ?> items in cart
