<?php if (isset($this->categories['items'])): ?>
            ...
            <nav class="catalog-header__menu menu-catalog">
                ...
                <div class="menu-catalog__sub-menu sub-menu-catalog">
                    ...
                    <div class="sub-menu-catalog__container container">
                        <?php
                        $sub_categories_to_show = $this->categories['sub_categories_to_show']; 
                        foreach($this->categories['items'] as $category):?>
                            <?php if ($category["sub_categories"]): ?>
                                <div hidden data-submenu="<?= htmlspecialchars($category['id'], ENT_QUOTES, 'UTF-8')?>" class="sub-menu-catalog__block">
                                    ...
                                    <?php endforeach;?>
                                    <?php foreach($category["sub_categories"] as $sub_category): ?>
                                        <?php if ($sub_category["sub_categories_count"] > $sub_categories_to_show): ?>
                                        ...
                                        <?php else: ?>
                                            <div class="sub-menu-catalog__footer-no-line">
                                            </div>
                                        <?php endif;?>
                                    <?php endforeach;?>
                                </div>
