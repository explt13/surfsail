<main class="page page_home">
    ...
    <section class="brands" data-spoilers="575">
        <div class="brands__container container">
            ...
            <div class="brands__cards">
                <?php foreach($this->data['brands'] as $brand): ?>
    ...
    <section class="categories" data-spoilers="575">
        <div class="categories__container container">
            ...
            <div class="categories__row">
                <?php foreach($this->data['categories']['items'] as $category): ?>
    ...
    if ($this->data['shortboard_products']) {
        ProductHelper::renderSliderCatalog($this->data['shortboard_products'], "Shortboards", $this->data['currency']);
    }
    if ($this->data['longboard_products']) {
        ProductHelper::renderSliderCatalog($this->data['longboard_products'], "Longboards", $this->data['currency'], 'big-gap');
    }
    ?>
    <?php if ($this->data['new_products']): ?>
            ...
            <div class="new-products__body">
                ...
                <div class="new-products__slider-body">
                    <div class="slider-new-products swiper new-products__slider">
                        <div class="swiper-wrapper">
                            <?php foreach($this->data['new_products'] as $product):?>
                                <div class="slider-products__slide slide-product-card swiper-slide">
                                    <?php ProductHelper::renderCard($this->data['currency'], $product);?>
                                </div>
                            <?php endforeach;?>
                        </div>
                        <div class="pagination">
    ...
    <?php endif;?>
    <?php
    if ($this->data['discount_products']){
        ProductHelper::renderSliderCatalog($this->data['discount_products'], "Sale", $this->data['currency']);
    }
    ?>
    <?php if ($this->data['recommend_products']):?>
    <section class="recommend">
        <div class="recommend__container container">
            <div class="recommend__body">
                <div class="reccomend__cards cards-recommend">
                    <?php foreach($this->data['recommend_products'] as $product): ?>
    ...
    <?php endif;?>
    <?php if ($this->data['gear_products']){
        ProductHelper::renderSliderCatalog($this->data['gear_products'], "Gear", $this->data['currency']);
    }
    ?>
    <?php if($this->data['articles']): ?>
