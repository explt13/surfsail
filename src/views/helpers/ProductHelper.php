<?php
namespace Surfsail\views\helpers;
...
class ProductHelper {
    ...
    public static function renderSliderCatalog(array $products, string $section_title, ?string $mod = null, bool $more = true)
    {
        if ($products): ?>
